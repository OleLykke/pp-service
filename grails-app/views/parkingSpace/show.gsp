...
<html>
    ...
    <body>
        ...
        <div id="show-parkingSpace" class="content scaffold-show" role="main">
            ...
            <f:display bean="parkingSpace" />
            <g:form resource="${this.parkingSpace}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.parkingSpace}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
